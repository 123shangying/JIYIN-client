    ...
    public CountDownProgressView(Context context, AttributeSet attrs) {
        ...
        if (typedArray != null) {
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_circSolidColor)) {
                ...
                //没有这个属性索引 默认是浅灰色
                circSolidColor = typedArray.getColor(R.styleable.CountDownProgress_circSolidColor, Color.parseColor("#F1F1F1"));
            }
            ...
            if (typedArray.hasValue(R.styleable.CountDownProgress_ProgressText_color)) {
                ...
                //没有这个属性索引 默认是白色
                textColor = typedArray.getColor(R.styleable.CountDownProgress_ProgressText_color, Color.parseColor("#000000"));
            }
